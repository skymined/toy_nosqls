...
collection_user_score = database['user_score']
...
collection_user_list.insert_one({"user_name" : user_name})
...
for i in doc:
    ...
    inserted_id = i['_id']
    num_count_question+= 1
    doc2 = collection_answer_list.find({"problems_id" : inserted_id})
    ...
    collection_user_score.insert_one({"user_answer" : user_answer})
